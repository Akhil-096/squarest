...
class ResalePropertyListCard extends StatefulWidget {
  final ResalePropertyModel resalePropertyModel;

  const ResalePropertyListCard({
    Key? key,
    required this.resalePropertyModel,
  }) : super(key: key);

  @override
  State<ResalePropertyListCard> createState() => _ResalePropertyListCardState();
}

class _ResalePropertyListCardState extends State<ResalePropertyListCard> {
              ...
              children: [
                ...
                Positioned(
                  bottom: (widget.resalePropertyModel
                      .posted_by_user_id !=
                      userProfileNotifier
                          .userProfileModel.id && (FirebaseAuth.instance.currentUser?.uid == null || (resalePropertyNotifier.memPlans.isEmpty || (resalePropertyNotifier.memPlans.isNotEmpty && !DateTime.now().isBefore(resalePropertyNotifier.memPlans[0].ending_on))))) ? MediaQuery.of(context).size.height * 0.015 : MediaQuery.of(context).size.height * 0.035,
                                    ...
                                    children: [
                                      SizedBox(
                                        ...
                                        child: (widget.resalePropertyModel
                                            ...
                                            : Text(widget.resalePropertyModel
                                                        .name,
                                                maxLines: 1,
                                                style: CustomTextStyles
                                                    .getProjectNameFont(
                ...
                Positioned(
                    ...
                    child: StreamBuilder(
                        ...
                        builder: (ctx, userSnapshot) {
                          likeButton = LikeButton(
                            size: 20,
                            isLiked: resaleProperty.isLiked,
                            likeBuilder: (isLiked) {
                              return isLiked
                                  ? Icon(
