...
class ResaleContact extends StatefulWidget {
  // final DateTime selectedDate;
  final ResalePropertyModel resaleProject;
  final String appBarTitle;
  // final bool isComingFromContactUs;

  const ResaleContact({required this.resaleProject, required this.appBarTitle, Key? key})
      : super(key: key);

  @override
  State<ResaleContact> createState() => _ResaleContactState();
}

class _ResaleContactState extends State<ResaleContact> {
  ...
  void initState() {
    ...
    messageTextEditingController = TextEditingController(text: 'I would like more information regarding the resale property ${widget.resaleProject.name} at ${widget.resaleProject.locality} ${widget.resaleProject.city}');
                                      ...
                                      if (userProfileNotifier.userProfileModel
                                        ...
                                        userProfileNotifier
                                          ...
                                          await userProfileNotifier
                                            ...
                                            if (response.statusCode == 200) {
                                              Fluttertoast.showToast(
                                                msg: 'SignUp and submit successful. We will contact you shortly.',
                                                backgroundColor: CupertinoColors.white,
                                                textColor: CupertinoColors.black,
                                                toastLength: Toast.LENGTH_LONG,
                                              );
                                        ...
                                        if (response.statusCode == 200) {
                                          Fluttertoast.showToast(
                                            msg: 'Sign in and submit successful. We will contact you shortly.',
                                            backgroundColor: CupertinoColors.white,
                                            textColor: CupertinoColors.black,
                                            toastLength: Toast.LENGTH_LONG,
                                          );
